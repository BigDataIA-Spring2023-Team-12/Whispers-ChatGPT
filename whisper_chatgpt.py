...
# Test
# transcript = transcribe_audio("ass-4/Apple Think Different - Steve Jobs Narrated Version.mp3","whisper-1")
...
# response = "The passage is trying to convey a message of admiration and encouragement for those who think differently and challenge the norms. It celebrates the crazy ones such as misfits, rebels, troublemakers who push the boundaries and ultimately drive progress and change in the world."
# print(create_prompt(response,questions))